...
export const ui = {
  ...
  footerTagline: {
    az: "Fullstack həllər, mobil tətbiqlər və AI avtomatlaşdırma.",
    en: "Fullstack solutions, mobile apps and AI automation.",
  },
  footerNav: { az: "KEÇİDLƏR", en: "LINKS" },
  footerContact: { az: "ƏLAQƏ", en: "CONTACT" },
  ...
  whyImportant: { az: "NİYƏ VACİBDİR?", en: "WHY IT MATTERS" },
  howItWorks: { az: "NECƏ İŞLƏYİR?", en: "HOW IT WORKS" },
  includes: { az: "NƏLƏR DAXİLDİR?", en: "WHAT'S INCLUDED?" },
  forWho: { az: "KİM ÜÇÜN?", en: "WHO IS IT FOR?" },
  conclusion: { az: "NƏTİCƏ", en: "CONCLUSION" },
  serviceDetails: { az: "XİDMƏT DETALLARI", en: "SERVICE DETAILS" },
  ...
  nav: {
    home: { az: "Əsas", en: "Home", href: "#home" },
